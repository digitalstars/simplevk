...
//**********CONFIG**************
/**
 * тот самый длинный ключ доступа сообщества
 */
const VK_KEY = "your_key";
/**
 ...
 * Код кнопки 'Fish'
 */
const BTN_FISH =  [["animals" => 'Fish'], "А какие бывают?", "blue"];
/**
 *  Код кнопки '<< Назад'
 */
const BTN_BACK =  [["command" => 'start'], "<< Назад", "red"];
/**
 * Код кнопки 'Горбуша'
 */
const BTN_SALMON = [["animals" => 'Pink_salmon'], "Горбуша", "white"];
/**
 * Код кнопки 'Золотая рыбка'
 */
const BTN_GOLDFISH = [["animals" => 'Goldfish'], "Золотая рыбка", "blue"];
/**
 * Код кнопки 'Плотва'
 */
const BTN_PLOTVA = [["animals" => 'Plotva'], "Плотва", "green"];
