...
### Класс VkCoin
#### Инициализация класса
* `$coin = new VkCoin(COIN_API_KEY, COIN_API_ID);` - `COIN_API_KEY` - Ключ вашего магазина; `COIN_API_ID` - идентификатор владельца магазина.
* `$vk = VkCoin::create(COIN_API_KEY, COIN_API_ID);` - `COIN_API_KEY` - Ключ вашего магазина; `COIN_API_ID` - идентификатор владельца магазина.
#### Методы класса
