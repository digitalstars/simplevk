...
* [Работа с placeholder(тегами)](#Работа-с-placeholder(тегами))
...
```
*******************
## Работа с placeholder(тегами)
Для методов reply, sendMessage, sendButton доступна работа с placeholder. Этот функционал пришел на замену getAlias, который теперь преимущественно используется для создания кастомных упоминаний, или генерации ссылок для использования в других методах
